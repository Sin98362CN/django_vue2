...
from app.utils.permissions import DocketUserPermission
...
import json
from app.utils.constFields import WORKFLOW_TYPE
...
class EventViewSet(ModelViewSet):
    ...
    def perform_create(self, serializer):
        ...
        distribute_type = '个人'
        obj = serializer.save(last_reviser=self.request.user, create_user=self.request.user)
        ...
        Docket.objects.create(docket_state='启用', workflow_type=WORKFLOW_TYPE, distribute_type=distribute_type,
        ...
        WorkflowAboutPeople.objects.create(request_id=obj.request_id, workflow_type=WORKFLOW_TYPE, uuid=obj.uuid, about_user=self.request.user.id)
